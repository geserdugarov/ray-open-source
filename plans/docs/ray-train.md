...
### BaseTrainer (`base_trainer.py`, 40 KB)
...
- `v2/` — Newer training API iteration with controller, worker group, checkpoint, callback, metrics, scaling-policy, local-mode, and framework integration layers
...
| File | Purpose |
|------|---------|
| `base_trainer.py` | BaseTrainer abstract class (40 KB) |
...
| `v2/` | New Train v2 API and execution stack |
