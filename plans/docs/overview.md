...
**Build System:** Bazel 7.5.0
**License:** Apache 2.0
**Branch Snapshot:** `master-described` is aligned with `master` at `9ed00cca01`, after the `master` rebase from `cf7ae60796`.
...
├── .claude/           Claude Code guidance, rules, and skills
├── doc/.claude/       Documentation-specific agent guidance and skills
