...
Repository-level guidance for coding agents. It summarizes build, test, lint, documentation, and architecture conventions for this described `upstream/releases/2.54.0` branch.

### Local Agent Configuration

**Location:** `.claude/` (ignored local directory, if present)

The release branch does not carry version-controlled Claude Code rule or skill directories. Documentation contribution guidance is in `doc/source/ray-contribute/docs.md` and `doc/README.md`.
