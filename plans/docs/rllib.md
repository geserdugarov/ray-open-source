...
### Algorithm (`algorithms/algorithm.py`, ~216 KB)
...
Configuration via `AlgorithmConfig` (`algorithm_config.py`, ~324 KB) — the most detailed configuration object in Ray, covering environment, model, training, resources, and multi-agent settings.
