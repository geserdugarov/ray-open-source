...
### Datasource V2 (`_internal/datasource_v2/`)
Newer file-oriented read path with explicit listing, chunking, partitioning, scanner, and reader components. The Parquet v2 path uses these pieces for file manifests, chunk sizing, pruning, and parallel reads.
...
| `_internal/datasource_v2/` | V2 listing, chunking, scanning, and reading path |
