...
### Datasource / Datasink (`datasource/`)
Pluggable I/O abstractions. ~10 built-in readers:
...
| File | Purpose |
|------|---------|
| `dataset.py` | Core Dataset class (309 KB) |
| `read_api.py` | Read functions (192 KB) |
